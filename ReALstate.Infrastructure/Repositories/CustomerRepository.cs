...
{
    // CustomerRepository implements ICustomerRepository interface and it is responsible for the CRUD operations of the Customer entity. EstateDbContext is injected in the constructor
