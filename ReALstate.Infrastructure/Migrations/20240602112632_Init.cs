        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LandAreaInSquareMeters = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AverageRoomHeightInMeters = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PriceFinal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PriceCalculated = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    NumberOfRooms = table.Column<int>(type: "int", nullable: false),
                    SuggestedTenantsQuantity = table.Column<int>(type: "int", nullable: true),
                    YearBuilt = table.Column<int>(type: "int", nullable: true),
                    Address_Country = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_Street = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address_City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address_Voivodeship = table.Column<string>(type: "nvarchar(max)", nullable: true),
